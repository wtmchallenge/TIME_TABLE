...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-scroll">
     ...
     <!-- <a href="<?= base_url('/consultation/pdf?semaine=' . date('Y-m-d', strtotime('monday this week'))) ?>"
        class="nav-link-item <?= str_starts_with(uri_string(), 'consultation/pdf') ? 'active' : '' ?>"
        target="_blank">
        ...
        <a href="<?= base_url('/disponibilites') ?>"
           class="nav-link-item <?= uri_string() === 'disponibilites' ? 'active' : '' ?>">
            <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-8 9z"/></svg>
            Mes disponibilités
        </a>
